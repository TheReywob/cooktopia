...
<body class="u-body u-stick-footer">
  ...
  <section class="u-align-center u-clearfix u-custom-color-1 u-section-1" id="sec-a638">
    <div class="u-clearfix u-sheet u-sheet-1">
      <h1 class="u-text u-text-default u-text-1">Browse Recipes</h1>
    </div>
  </section>
          ...
          <div class="u-layout-col">
            <div class="u-size-30">
              <div class="u-layout-row">
                ...
                // Connect to database
                require "connect.php";
                // Select all entries from recipes (newest to oldest)
                $sql = "select * from recipes order by eDate desc";
                ...
                echo '<input name="submit[' . $row['eId'] . ']" type="submit" value="Save" class="u-align-center u-border-3 u-border-palette-3-base u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-1" style="border-width:3px">';
                echo '</form>';
                ...
                echo '<h4 class="u-align-center u-text u-text-default u-text-grey-15 u-text-5">Uploaded by '.$creator.' on '.$row['eDate'].'</h4>';
