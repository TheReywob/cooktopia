...
<link rel="stylesheet" href="new_recipe.css" media="screen">
  ...
  <body class="u-body u-stick-footer">
    ...
    <section class="u-border-2 u-border-palette-3-base u-clearfix u-custom-color-1 u-section-1" id="sec-b831">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-1">Upload A New Recipe</h1>
        <div class="u-align-center u-border-3 u-border-palette-3-base u-form u-palette-1-base u-radius-50 u-form-1">

          <form action="insert.php" method="POST" enctype="multipart/form-data" class="u-clearfix u-form-custom-backend u-form-spacing-5 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 50px;">
            <!-- Recipe Title -->
            <div class="u-form-group u-form-group-1">
              <label for="name" class="u-label u-label-1">Recipe Title:</label>
              <input type="text" placeholder="" id="text-fd5f" name="name" class="u-border-3 u-border-custom-color-1 u-input u-input-rectangle u-radius-6 u-white" required="required">
            </div>
            <!-- Recipe Description -->
            <div class="u-form-group u-form-message u-form-textarea u-form-group-2">
              ...
              <textarea rows="4" cols="50" id="textarea-a6be" name="description" class="u-border-3 u-border-custom-color-1 u-input u-input-rectangle u-radius-6 u-white" required="required" placeholder="A family classic fettuccine alfredo recipe"></textarea>
            </div>
            <!-- Recipe Ingredients -->
            <div class="u-form-group u-form-textarea u-form-group-3">
              ...
              <textarea rows="4" cols="50" id="textarea-909b" name="ingredients" class="u-border-3 u-border-custom-color-1 u-input u-input-rectangle u-radius-6 u-white" required="required" placeholder="1 cup flour + 2 eggs + 1 1/2 cups milk"></textarea>
            </div>
            <!-- Recipe Instructions -->
            <div class="u-form-group u-form-textarea u-form-group-4">
              ...
              <textarea rows="4" cols="50" id="textarea-ddcc" name="instructions" class="u-border-3 u-border-custom-color-1 u-input u-input-rectangle u-radius-6 u-white" required="required" placeholder="Add flour, eggs, and milk to a bowl. + Whisk together until..."></textarea>
            </div>
            <!-- Recipe Skill Level -->
            ...
            <div class="u-form-group u-form-textarea u-form-group-7">
              <label for="userImage" class="u-label u-label-11">Upload Image</label></br>
              <input type="file" name="userImage" id="userImage" accept=".jpg,.jpeg,.png,.gif,.heif">
            </div>
        ...
        <a href="browse.php" data-page-id="2997711219" class="u-align-center u-border-3 u-border-palette-3-base u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-2">Cancel</a>
      </div>
    </section>
